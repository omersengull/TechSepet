                ...
                <>
                    ...
                    <div className="flex flex-col bg-renk1 h-auto px-4 lg:px-16 text-white">
                        <div className="flex flex-row h-[80px] justify-between items-center gap-3">
                            ...
                            <div onClick={()=>{router.push('/dsearch')}} className="rounded-xl flex flex-row items-center cursor-pointer border-white border-2 md:px-6 px-3 md:py-3 sm:py-2 xs:py-1">
